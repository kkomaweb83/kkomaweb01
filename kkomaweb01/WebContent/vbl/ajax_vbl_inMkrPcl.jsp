...
<!-- 왼쪽 상단 상품분류 검색조건 -->
<table style="border-spacing: 0px; padding: 0; background-color:white; width: 390px; border: 1px solid black; margin-top: 2px; ">
<tbody>

<!-- 제조사 -->
<tr>
<td style="padding: 1px; width: 390px;">
<table style="padding: 0; width: 100%; border: 0px; border-spacing: 0px;">
<tbody><tr>
<td style="width: 50%;">
<select style="width: 192px;" onchange="goPptProChk(this);" name="maker">
...
<input type="text" value="" style="width: 120px;" name="searchValue"/>
<img height="21" width="42" style="cursor: pointer;" onclick="search_keyword();" src="<%=cp %>/img/btn_search1.gif"/>
</td>
</tr>
</tbody></table>
</td>
