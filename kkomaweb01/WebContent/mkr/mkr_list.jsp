...
<script type="text/javascript">
	...
	function chkPclList(mk_pcl_no){
		location.href = "<%=cp %>/MkrController?dana=mkr_list&mkr_insert=y&mkr_pcl_no="+mk_pcl_no.value;
	}
	...
	function doMkrInsert(){
		...
		document.mkr_insert.action = "<%=cp %>/MkrController?dana=mkr_insert";
	...
	function doMkrUpdate(){
		...
		document.mkr_insert.action = "<%=cp %>/MkrController?dana=mkr_update";
		document.mkr_insert.submit();	
	}

	function doMkrDelete(){
		document.mkr_insert.action = "<%=cp %>/MkrController?dana=mkr_delete";
		document.mkr_insert.submit();	
	}
</script>
</head>
<body>
	...
	<div style="width: 800px;">
		...
		<tbody>
			...
			<a href="<%=cp %>/MkrController?dana=mkr_preUpdate&mkr_no=${bean.mkr_no}&mkr_pcl_no=${bean.mkr_pcl_no}&mkr_insert=n">${bean.mkr_name }</a>
			</td>
