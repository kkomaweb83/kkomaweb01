...
public class PclInsertCommand implements BaseCommand {
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) {
		...
		pclVO.setPcl_step(Integer.parseInt(request.getParameter("pcl_step")));
		pclVO.setPcl_basis(request.getParameter("pcl_basis"));
		pclVO.setPcl_upperno(request.getParameter("pcl_upperno"));
		pclVO.setPcl_old_upperno(request.getParameter("pcl_upperno"));
